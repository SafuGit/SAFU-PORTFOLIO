...
const Navbar = () => {
  return (
    <div className="flex justify-center">
      <div className="flex NavbarStyle rounded-full justify-center gap-4 navbar w-fit p-2! text-white border border-y-gray-950">
        <div className="rounded-full p-2! flex gap-1 hover:bg-green-950 transition-colors duration-300 ease-in-out">
